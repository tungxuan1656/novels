...
- **Heading exclusion:** AI input is heading-free body text. Before chunking, the app drops only the first heading block via the shared `joinedBodyText` helper; chapters without a heading chunk exactly as before.
